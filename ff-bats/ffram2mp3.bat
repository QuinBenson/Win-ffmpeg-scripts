...
ffmpeg -i "!l_Filename!" -acodec libmp3lame -b:a 192k -metadata album="!l_album!" -metadata composer="%m_composer%" -metadata album_artist="%m_album_artist%" -metadata artist="%m_artist%" -metadata title="!l_album! Part !l_track!" -metadata track="!l_track!" -metadata publisher="%m_publisher%" -y "!l_basename!.mp3"
